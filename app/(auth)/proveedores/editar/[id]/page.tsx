  ...
  const EditarProveedor: React.FC = () => {
    ...
    const fetchProveedor = async () => {
      ...
      try {
        ...
        const tablaArchivos =
          proveedor.tipo_persona === 'Física' ? 'archivos_p_fisica' : 'archivos_p_moral';
  ...
  const handleGuardar = async () => {
    ...
    try {
      ...
      const tablaArchivos =
        tipoPersona === 'Física' ? 'archivos_p_fisica' : 'archivos_p_moral';
      ...
      for (const archivo of archivosNuevos) {
        ...
        if (updateArchivoError) {
          alert(
            `Error actualizando registro de archivo ${archivo.nombre}: ${updateArchivoError.message}`
          );
          setLoading(false);
          return;
        }
