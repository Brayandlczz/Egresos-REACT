...
export default function PSBGPFForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-5xl p-6 space-y-6">
      ...
      <section className={section}>
        <h2 className={legend}>B) Prestador de Servicio (Persona Física)</h2>
      ...
      <section className={section}>
        <h2 className={legend}>C) Objeto del contrato</h2>
      ...
      <section className={section}>
        <h2 className={legend}>E) Evento y horario de acceso</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div>
