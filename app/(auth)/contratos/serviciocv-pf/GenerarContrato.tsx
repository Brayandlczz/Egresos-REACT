...
type Props = {
  values: PSBGPFFormValues;
  autoExportOnValuesChange?: boolean;
  onExportDone?: () => void;
};

export default function ContratoPSBGPF({
  values,
  ...
  const generarDocx = async () => {
    ...
    const pagoMedioMap: Record<PSBGPFFormValues["pagoMedio"], string> = {
      ...
      sections: [
        {
          ...
          children: [
            new Paragraph({
              ...
              children: [new TextRun({ text: "CONTRATO PSB Y G-PF.", bold: true, size: 24 })],
            }),
            ...
            new Paragraph({
              spacing: { after: 200 },
              children: [new TextRun(`3.- Que tiene su domicilio fiscal en ${values.proveedorDomicilio}; el cual lo acredita con su constancia de situación fiscal que exhibe en este momento.`)],
            }),
            new Paragraph({
              spacing: { after: 200 },
            ...
            new Paragraph({
              spacing: { after: 200 },
              children: [new TextRun(`UNO. OBJETO DEL CONTRATO. - La contratante manifiesta que hará la clausura de los alumnos que han cursado el ciclo escolar 2021 – 2024; por lo que requiere de “EL PRESTADOR DE SERVICIO” el ${values.objetoCorto || "Banquete de Graduación"}, que deberá incluir lo siguiente:`)],
            }),
    ...
    saveAs(blob, "Contrato_PSB_G_PF.docx");
  };
